        ...
        <div class="wrapper-page">
            <div class="card-box">
                <div class="panel-heading">
                    <h4 class="text-center"> <img src="assets/images/theManagerLogo.png"></h4>
                </div>
                ...
                <div class="p-20">
                    <form class="form-horizontal m-t-20" action="#">
                        ...
                        <div class="form-group text-center m-t-40">
                            <div class="col-12">
                                <a href="administration.php" class="btn btn-inverse btn-block text-uppercase waves-effect waves-light"
                                        type="submit">Log In
                                </a>
                            </div>
                        </div>
