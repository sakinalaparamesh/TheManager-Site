        ...
        <div class="col-md-12">
            <form role="form" id="frm_billing_conf">
                ...
                <div class="form-group row">
                    <label for="billing_address_contact_person" class="col-md-5">Billing Contact Person Name<span class="text-danger">*</span></label>
                    <div class="col-md-7">
                ...
                <div class="form-group row">
                    <label for="billing_address_contact_person_email" class="col-md-5">Billing Contact Person Email<span class="text-danger">*</span></label>
                    <div class="col-md-7">
                ...
                <div class="form-group row">
                    <label for="billing_address_contact_person_mobile" class="col-md-5">Billing Contact Person Phone<span class="text-danger">*</span></label>
                    <div class="col-md-7">
                ...
                <div class="form-group row">
                    <label for="billing_address" class="col-md-5">Billing Address<span class="text-danger">*</span></label>
                    <div class="col-md-7">
                ...
                <div class="form-group row">
                    <label for="billing_address_currency_code" class="col-md-5">Billing Currency Code<span class="text-danger"></span></label>
                    <div class="col-md-7">
                        <select id="billing_address_currency_code" class="form-control input-sm" name="billing_address_currency_code">
                            ...
                            <option value="<?=$list->billing_address_currency_code?>" <?=($list->billing_address_currency_code==@$details->billing_address_currency_code)?"selected":""?>><?=$list->currency_code?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="billing_address_currency_display" class="col-md-5">Billing Currency Display<span class="text-danger"></span></label>
                    <div class="col-md-7">
