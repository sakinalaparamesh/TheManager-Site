...
<div class="col-md-12 text-right m-b-10">
    <a class="btn btn-default btn-sm" href="<?php echo base_url('User/addOrEdit'); ?>">Add <i class="fa fa-plus-add"></i></a>
</div>
<div class="col-md-12 test">                            
<div class="table-responsive">
<table id="tbluser" class="table-bordered table-condensed table-hovered">
        <thead>
        <tr>
            ...
            <th data-field="data">IsEmployee</th>
...
<script src="<?= base_url() ?>assets/js/pages/user/user_grid.js" type="text/javascript"></script>