                ...
                <div class="col-md-12">
                    <form role="form" id="frmuser">
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="username" id="txtusername" parsley-type="txtusername" class="form-control input-sm"  placeholder="Name">
                            </div>
                        </div>
                        ...
                        <!--                        <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <select id="department_list" class="form-control input-sm" name="departmentid" required="">
                        ...
                        <?php } ?>
                                                ...
                                                <div class="form-group row">
                                                    <label for="role_id" class="col-md-2">Roles<span class="text-danger">*</span></label>
                                                    <div class="col-md-4">
                                                        <select id="role_id" class="form-control input-sm" name="role_id">
                                                            <option value="Exclusive Agent">Exclusive Agent</option>
                                                        </select>
                                                    </div>
                                                </div>-->
                        <!--                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label for="reporting_to" class="col-md-2">Reporting to<span class="text-danger">*</span></label>
                            <div class="col-md-4">
                                <input type="text" name="admin" id="admin" value="Admin" parsley-type="contactno" class="form-control input-sm" placeholder="Reporting To" readonly="">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="txtcontactno" class="col-md-2">   Mobile No  <span class="text-danger">*</span></label>
                            <div class="col-md-4">
                        ...
                        <div class="form-group row">
                            <label for="user_countryid" class="col-md-2">Country
                                <span class="text-danger">*</span></label>
                            <div class="col-md-4">
                                <select class="form-control" name="user_countryid" id="user_countryid">
...
<!-- end wrapper -->
<script src="<?php echo base_url(); ?>assets/validations/userValidation.js" type="text/javascript"></script>

<script type="text/javascript">
    $(document).ready(function () {
        var _baseUrl = '<?php echo base_url(); ?>';
        userjs.Load(_baseUrl);
    })
</script>