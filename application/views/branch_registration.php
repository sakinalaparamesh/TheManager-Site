    ...
    <div class="col-md-12">
        <form role="form" >
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-md-2">Branch Name<span class="text-danger">*</span></label>
                                    <div class="col-md-4">
                                ...
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-md-2"> Address <span class="text-danger">*</span></label>
                                    <div class="col-md-4">
                                        <textarea class="form-control" rows="3"></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-md-2"> Phone No <span class="text-danger">*</span></label>
                                    <div class="col-md-4">
                                ...
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-md-2">   Fax No  <span class="text-danger">*</span></label>
                                    <div class="col-md-4">
                                        <input type="text" required="" parsley-type="name" class="form-control input-sm" id="inputEmail3" placeholder="Contact No ">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-md-2">   Email  <span class="text-danger">*</span></label>
                                    <div class="col-md-4">
                                        <input type="text" required="" parsley-type="name" class="form-control input-sm" id="inputEmail3" placeholder="Email">
                                    </div>
                                </div>
